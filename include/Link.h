  ...
  #define F_CONST 0
  #define F_RESS_FREIN 1
  #define F_RESS_FREIN_SEUIL 2
...
static void AlgoRessortFreinSeuil(Link* L)
{
  double d; // distance 
  double e; // Elongation 
  double f; // force
...
extern void RessortFreinSeuil(Link* L, double k, double z,double s)
{
  L->type   = F_RESS_FREIN_SEUIL;
  L->setup  = &AlgoRessortFreinSeuil;
  L->k      = k ;
  L->z      = z ;
  L->s      = s;
  L->l      = 0.;
